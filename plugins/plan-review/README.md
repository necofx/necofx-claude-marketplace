...
```sh
codex exec --sandbox read-only -o <report>.md < <prompt>.md
```

Say no — or run it yourself later, or on another machine — and the same line is yours to paste. Three things about it are deliberate:
